...
export function Plugins({}) {
  ...
  return (
    <div className="relative">
      <ToolbarPlugin>
        {({ blockType }) => (
          <div className="vertical-align-middle sticky top-0 z-10 flex items-center gap-2 overflow-auto border-b p-1 flex-wrap">
            ...
            <div className="">
              <div className="" ref={onRef}>
                <ContentEditable
                  ...
                  className="ContentEditable__root relative block  min-h-100 max-h-100 overflow-auto px-6 py-4 focus:outline-none"
                />
              </div>
            </div>
          }
      ...
      <ActionsPlugin>
        <div className="clear-both flex items-center flex-wrap justify-center sm:justify-between gap-2 overflow-auto border-t p-1">
